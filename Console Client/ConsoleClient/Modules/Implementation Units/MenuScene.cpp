...
void MenuScene::Start()
{
    m_lobbyCode = "";
    m_nextScene = nullptr;
    m_console->NewConsole(L"Menu", 50, 20);
    m_console->SetConsoleFont(L"MS Gothic", 24, 24);


    m_objects.emplace_back(new Label{23, 2, Align::Left, Align::Up, Color::Cyan, Color::Magenta, 6, 1, m_console, "GARTIC"});


    auto createLobbyButton{ new Button{20, 7, Align::Center, Align::Center, Color::DarkGray, Color::Green,
    ...
    auto layout{ new HorizontalLayout{20, 12, Align::Left, Align::Center, Color::Black, 30, 3, m_console, 0} };
    ...
    auto codeField{ new InputField{Align::Center, Align::Center, Color::Gray, Color::Black, 5, 3, Color::DarkBlue, Color::White,
                        m_console, m_input, m_selected, m_lobbyCode, 5} };
